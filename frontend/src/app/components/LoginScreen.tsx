            ...
            <>
              ...
              <div className="flex items-center gap-2 mb-10">
                <div className="w-9 h-9 bg-[#c9a84c] rounded flex items-center justify-center">
                  <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: 16, color: "#0a0a0f" }}>R</span>
                </div>
                <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 600, fontSize: 20, color: "#f0ede8", letterSpacing: "0.05em" }}>
                  RENTA
                </span>
              </div>
